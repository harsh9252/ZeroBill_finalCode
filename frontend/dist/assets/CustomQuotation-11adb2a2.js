import{r as f,j as e,ag as ne,ad as ie,aq as le,aG as oe,x as ke,b9 as xe,bg as _e,A as re,am as ce,u as ue,aF as Se,aH as Te,aI as Ce,aJ as pe,P as te,F as Ee}from"./vendor-11ec2bdb.js";import{n as Pe,D as Ie,i as fe,f as W,k as ze,l as Ae,e as de,t as se,o as X,T as $e,p as Oe,g as Le,M as De,b as me,G as Fe,R as Re,c as Be,h as Me}from"./index-2e4c08ca.js";const be=f.forwardRef(({quotationData:t},x)=>{var y;if(!t)return e.jsx("div",{className:"p-8 text-center text-gray-400",children:"Loading Preview..."});const{company:d,customer:g,quotation:s,termsSections:p}=t;return e.jsxs("div",{ref:x,className:"preview-wrapper py-10 flex flex-col items-center gap-10 w-full font-sans print:py-0",children:[e.jsx("style",{children:`
