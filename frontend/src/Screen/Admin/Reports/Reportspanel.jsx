        ...
        <div className=" flex items-center justify-between gap-4 p-2  border-b border-yellow-200">
          ...
          <div className="flex items-center gap-2"> 
            <input
              ...
              className="px-3 py-0 h-8 border border-gray-300 rounded-[7px] text-sm focus:outline-none focus:ring-1 focus:ring-green-300"
            />
                ...
                return (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-sm border ${
                      active ? "bg-[#129046] text-white border-[#129046]" : "bg-white text-yellow-700 border-gray-200"
                    ...
                    {filtered.length > 5 && (
                      <div className="mt-3">
                        <button
                          ...
                          className="text-sm text-[#129046] hover:underline"
                        >
